...
// use reduce to sum the amount pledged across all games
...
// set the inner HTML to the total number of games
...
const unfundedGamesStr = `A total of ${unfundedGamesCount} ${unfundedGamesCount === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
